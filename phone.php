...
$phone=$_POST["phone"];
    $phone_update="UPDATE user SET phone='$phone' where user_id='$id'";
    $user_query=mysqli_query($db,$phone_update);
    if ($user_query) {
...
<html lang="fr" dir="ltr">
    ...
    <body>
        ...
        <article>
          <form class="modif" action="phone.php" method="post">
            <div class="txt">
              <input type="number" name="phone" placeholder="téléphone" value="<?php echo "0".$result['phone']; ?>">
